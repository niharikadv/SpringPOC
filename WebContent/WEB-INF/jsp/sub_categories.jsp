...
<html>
 ...
 <%-- <jsp:include page="/WEB-INF/jsp/header.jsp"></jsp:include> --%>
 	<div align="center">
	<h1>SUB CATEGORIES OF A CATEGORY</h1>
		<br>
		<h2><a href="subCategory.html?value=${subCategoryName}"><c:out value="${subCategoryName}" /></a></h2> 
		<h2><a href="subCategory.html?value=${subCategory}"><c:out value="${subCategory}" /></a> </h2>
		<h2><a href="subCategory.html?value=${sub_Category}"><c:out value="${sub_Category}" /></a> </h2>
	</div>
	</body>
</html>
